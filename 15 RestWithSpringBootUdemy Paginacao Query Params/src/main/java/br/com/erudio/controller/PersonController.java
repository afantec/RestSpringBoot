...
public class PersonController {
	...
	public ResponseEntity<?> findAll(
		...
		PagedResources<?> resouces = assembler.toResource(persons);
		
		return new ResponseEntity<>(resouces,HttpStatus.OK);
	}	
	
	@ApiOperation(value = "Find all people by name" ) 
	...
	@PatchMapping(value = "/{id}/{bool}", produces = { "application/json", "application/xml", "application/x-yaml" })
	public PersonVO enablePerson(@PathVariable("id") Long id, @PathVariable("bool") boolean bool) {
		PersonVO personVO = service.enablePerson(id, bool);
		personVO.add(linkTo(methodOn(PersonController.class).findById(id)).withSelfRel());
		return personVO;
	}	
